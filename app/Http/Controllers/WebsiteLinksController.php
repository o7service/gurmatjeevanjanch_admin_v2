...
class WebsiteLinksController extends Controller
{
    ...
    {
        $websiteLinks = websiteLinks::orderBy('isBlocked', 'asc')
            ->orderBy('id', 'desc')
            ->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            $totalLinks = websiteLinks::count();
            $newLink = new websiteLinks();
    ...
    {
        $link = websiteLinks::findOrFail($id);
    ...
    {
        $websiteLinks = websiteLinks::where('isDeleted', false)
    ...
    public function singleLink(Request $request)
    {
        ...
        $link = websiteLinks::where('id', $request->id)->first();
        if (!$link) {
            return response()->json([
                'success' => false,
                'status' => 404,
