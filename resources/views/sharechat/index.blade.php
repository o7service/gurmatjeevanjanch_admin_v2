...
@section('content')
    <div class="container">
        <div class="page-inner">
            ...
            <div class="page-header">
                <h3 class="fw-bold mb-3">Sharechat Link</h3>
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a href="#">Sharechat Link</a></li>
                </ul>
            </div>

            <!-- Sharechat Links Table -->
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <!-- Card Header -->
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
                            <h5 class="card-title mb-0">Sharechat Link List</h5>
                            <!-- Add Button -->
                            <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#sharechatLinkModal" onclick="prepareAddForm()">
                                ...
                                <tbody>
                                    @foreach ($sharechatLinks as $t)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <form action="{{ route('sharechat.status', $t->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
    ...
    <!-- Add/Edit Modal -->
    <div class="modal fade" id="sharechatLinkModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="sharechatLinkModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm ">
            <form id="sharechatForm" onsubmit="submitForm(); return false;">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="sharechatLinkModalLabel">Modal title</h1>
    ...
    <script>
        ...
        function prepareAddForm() {
            formType = "add";
            resetForm();
            document.getElementById('sharechatLinkModalLabel').innerText = "Add Sharechat Link";
        ...
        function fetchData(id) {
            showSpinner();
            formType = "edit";
            document.getElementById('sharechatLinkModalLabel').innerText = "Edit Sharechat Link";
            ...
            fetch(`/sharechat/${id}`)
                ...
                .then(data => {
                    ...
                    // Show modal
                    hideSpinner()
                    const modal = new bootstrap.Modal(document.getElementById("sharechatLinkModal"));
                    modal.show();
                })
        ...
        function submitForm() {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    const modalEl = document.getElementById('sharechatLinkModal');
