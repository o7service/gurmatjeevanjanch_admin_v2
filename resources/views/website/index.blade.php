...
@section('content')
    <div class="container">
        <div class="page-inner">
            ...
            <div class="page-header">
                <h3 class="fw-bold mb-3">Website Link</h3>
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a href="#">Website Link</a></li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
                            <h5 class="card-title mb-0">Website Link List</h5>
                            <!-- Add Button -->
                            <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#websiteLinkModal" onclick="prepareAddForm()">
                                ...
                                <tbody>
                                    @foreach ($websiteLinks as $t)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <form action="{{ route('website.status', $t->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
    ...
    <!-- Add/Edit Modal -->
    <div class="modal fade" id="websiteLinkModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="websiteLinkModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm ">
            <form id="websiteForm" onsubmit="submitForm(); return false;">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="websiteLinkModalLabel">Modal title</h1>
    ...
    <script>
        ...
        function prepareAddForm() {
            formType = "add";
            resetForm();
            document.getElementById('websiteLinkModalLabel').innerText = "Add Website Link";
        ...
        function fetchData(id) {
            showSpinner();
            formType = "edit";
            document.getElementById('websiteLinkModalLabel').innerText = "Edit Website Link";
            ...
            fetch(`/website/${id}`)
                ...
                .then(data => {
                    ...
                    // Show modal
                    hideSpinner()
                    const modal = new bootstrap.Modal(document.getElementById("websiteLinkModal"));
                    modal.show();
                })
        ...
        function submitForm() {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    const modalEl = document.getElementById('websiteLinkModal');
