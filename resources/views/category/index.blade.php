...
@section('content')
    ...
    <script>
            ...
            fetch(`/category/${id}`)
                ...
                .then(data => {
                    ...
                    if (data.icon) {
                        ...
                        document.getElementById('currentImage').src = `/categories/${data.icon}`;
                    }
                    // Show modal
                    hideSpinner()
        ...
        function submitForm() {
            ...
            let url = '/category'; // default add URL

            if (formType === 'edit') {
                url = `/category/${id}`;
                formData.append('_method', 'PUT'); // ✅ Laravel PUT method
            }

            showSpinner();

            fetch(url, {
                method: 'POST', // always POST, Laravel uses _method=PUT
                headers: {
