...
@section('content')
    <div class="container">
        <div class="page-inner">
            ...
            <div class="page-header">
                <h3 class="fw-bold mb-3">Facebook Links</h3>
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a href="#">Facebook Links</a></li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
                            <h5 class="card-title mb-0">Facebook Links List</h5>
                            <!-- Add Button -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#facebookLinkModal" onclick="prepareAddForm()">
                                ...
                                <tbody>
                                    @foreach ($facebookLinks as $t)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <form action="{{ route('facebook.status', $t->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
    ...
    <!-- Add/Edit Modal -->
    <div class="modal fade" id="facebookLinkModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="facebookLinkModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm ">
            <form id="facebookForm" onsubmit="submitForm(); return false;">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="facebookLinkModalLabel">Modal title</h1>
    ...
    <script>
        ...
        function prepareAddForm() {
            formType = "add";
            resetForm();
            document.getElementById('facebookLinkModalLabel').innerText = "Add Facebook Link";
        ...
        function fetchData(id) {
            showSpinner();
            formType = "edit";
            document.getElementById('facebookLinkModalLabel').innerText = "Edit Facebook Link";
            ...
            fetch(`/facebook/${id}`)
                ...
                .then(data => {
                    ...
                    // Show modal
                    hideSpinner()
                    const modal = new bootstrap.Modal(document.getElementById("facebookLinkModal"));
                    modal.show();
                })
        ...
        function submitForm() {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    const modalEl = document.getElementById('facebookLinkModal');
