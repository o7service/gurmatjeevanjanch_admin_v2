...
@section('content')
    <div class="container">
        <div class="page-inner">
            ...
            <div class="page-header">
                <h3 class="fw-bold mb-3">Zoom Link</h3>
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a href="#">Zoom Link</a></li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
                            <h5 class="card-title mb-0">Zoom Link List</h5>
                            <!-- Add Button -->
                            <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#zoomLinkModal" onclick="prepareAddForm()">
                                ...
                                <tbody>
                                    @foreach ($zoomLinks as $t)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <form action="{{ route('zoom.status', $t->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
    ...
    <!-- Add/Edit Modal -->
    <div class="modal fade" id="zoomLinkModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="zoomLinkModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm ">
            <form id="zoomForm" onsubmit="submitForm(); return false;">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="zoomLinkModalLabel">Modal title</h1>
    ...
    <script>
        ...
        function prepareAddForm() {
            formType = "add";
            resetForm();
            document.getElementById('zoomLinkModalLabel').innerText = "Add Zoom Link";
        ...
        function fetchData(id) {
            showSpinner();
            formType = "edit";
            document.getElementById('zoomLinkModalLabel').innerText = "Edit Zoom Link";
            ...
            fetch(`/zoom/${id}`)
                ...
                .then(data => {
                    ...
                    // Show modal
                    hideSpinner()
                    const modal = new bootstrap.Modal(document.getElementById("zoomLinkModal"));
                    modal.show();
                })
        ...
        function submitForm() {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    const modalEl = document.getElementById('zoomLinkModal');
