...
@section('content')
    <div class="container">
        <div class="page-inner">
            ...
            <div class="page-header">
                <h3 class="fw-bold mb-3">Telegram Links</h3>
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a href="#">Telegram Links</a></li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
                            <h5 class="card-title mb-0">Telegram Links List</h5>
                            <!-- Add Button -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#telegramLinkModal" onclick="prepareAddForm()">
                                ...
                                <tbody>
                                    @foreach ($telegramLinks as $t)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col">
                                                    <form action="{{ route('telegram.status', $t->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
    ...
    <!-- Add/Edit Modal -->
    <div class="modal fade" id="telegramLinkModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="telegramLinkModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <form id="telegramForm" onsubmit="submitForm(); return false;">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="telegramLinkModalLabel">Modal title</h1>
    ...
    <script>
        ...
        function prepareAddForm() {
            formType = "add";
            resetForm();
            document.getElementById('telegramLinkModalLabel').innerText = "Add Telegram Link";
        ...
        function fetchData(id) {
            showSpinner();
            formType = "edit";
            document.getElementById('telegramLinkModalLabel').innerText = "Edit Telegram Link";
        ...
        function submitForm() {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    const modalEl = document.getElementById('telegramLinkModal');
